...
4.  **Testing:** A comprehensive testing strategy will be implemented using `go-vcr` for API mocking and golden files for output validation, mirroring the approach in `linear-mcp-go`.
